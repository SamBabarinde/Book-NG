...
$("#commentForm").submit(function(e){
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.bool == true){
                $("#review-rep").html("Review added successfully.")
...
$(document).ready(function (){
    $(".filter-checkbox, #price-filter-btn").on("click", function(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            beforeSend: function(){
                console.log("Trying to filter book...");
            },
   ...
   // <================================================ FOR THE MAXIMUM AND MINIMUM PRICE ===========================================>
    ...
    $("#max_price").on("blur", function(){
        ...
        if(current_price < parseInt(min_price) || current_price > parseInt(max_price)){
            ...
            alert("The lowset book is $" +min_price + ' and the highest is $' +max_price)
            $(this).val(min_price)
            $('#range').val(min_price)
    ...
    $(".add-to-cart-btn").on("click", function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $(".cart-items-count").text(response.totalcartbooks)
    ...
    //         success: function(response){
    //             // this_val.html("✓")
    //             this_val.html("Book added to cart")
    ...
    $(".delete-cart-book").on("click", function(){
        ...
        $.ajax({
            ...
            success: function(response){
                this_val.show()
                $(".cart-items-count").text(response.totalcartbooks)
                $("#cart-list").html(response.context)
            }
        })
    ...
    $(".refresh-cart-book").on("click", function(){
    ...
    $(document).on("click", ".delete-wishlist-product", function(){
        ...
        $.ajax({
            ...
            success: function(override){
                $("#wishlist-list").html(override.data)
            }
        })
    })
    ...
    $(document).on("submit", "#contact-form-ajax", function(e){
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                $("#message-response").html("Thanks for your feedback, we will get back to you.")
            }
        })
    })
